...
fn semver_from_range(pgrx_range: &str) -> Result<String, PgrxBuildError> {
    let versions = [
        "0.13.1", "0.13.0", "0.12.9", "0.12.8", "0.12.7", "0.12.6", "0.12.5", "0.12.4", "0.12.3",
        "0.12.2", "0.12.1", "0.12.0", "0.11.4", "0.11.3", "0.11.2", "0.11.1", "0.11.0", "0.10.2",
        "0.10.1", "0.10.0", "0.9.8", "0.9.7", "0.9.1", "0.9.0", "0.8.4", "0.8.3", "0.8.0", "0.7.4",
    ];
