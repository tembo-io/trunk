-- update to query that returns the latest version of each extension
-- fixes bug related to sorting by latest version
...
WITH latest_versions AS (
    SELECT
        ...
        v.license,
        ROW_NUMBER() OVER(PARTITION BY v.extension_id ORDER BY string_to_array(v.num, '.')::int[] DESC) AS rn
